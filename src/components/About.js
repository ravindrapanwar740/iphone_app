...
function About() {
  return (
    ...
    // <div>
    //   <b>The iPhone 12 and iPhone 12 mini<br/> are part of Apple's 2020 <br/> generation of smartphones, <br/> offering OLED displays,<br/>  5G connectivity, an A14 chip,<br/>  improved cameras, and MagSafe,<br/>  all in a squared-off design.</b>
    // </div>

    // <div>
    //   <h1>iPhone 12 - Technical Specifications</h1>
    //   <p>
    //     <ul>
    //       <li>
    //         <b>Finish:</b>
    ...
    //       </li>
    //       <li>
    //         <b> TrueDepth Camera </b>
    //         12MP camera
    //         <br />
    //         ƒ/2.2 aperture
    //         <br />
    //         Portrait Lighting with six effects (Natural, Studio, Contour, Stage,
    //         Stage Mono, High-Key Mono)
    //         <br />
    //         Animoji and Memoji
    //         <br />
    //         Night mode
